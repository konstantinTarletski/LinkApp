...
@Data
@Entity
@Table(name = "pcd_locks")
public class PcdLock implements java.io.Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "fld_049", updatable = false, insertable = false)
    private PcdCurrency pcdCcyFld049;

    @ToString.Exclude
    @EqualsAndHashCode.Exclude
    @ManyToOne
    @JoinColumn(name = "fld_051", updatable = false, insertable = false)
    private PcdCurrency pcdCcyFld051;
