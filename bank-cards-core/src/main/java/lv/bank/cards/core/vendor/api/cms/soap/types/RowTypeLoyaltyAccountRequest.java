...
@XmlType(name = "RowType_LoyaltyAccountRequest", propOrder = {
    "card",
    "lscode",
    "clientid",
    "lyinvitedbyid"
...
public class RowTypeLoyaltyAccountRequest {
    ...
    @XmlElement(name = "LY_INVITED_BY_ID")
    protected String lyinvitedbyid;
     ...
     *     
     */
    public String getLYINVITEDBYID() {
     ...
     *     
     */
    public void setLYINVITEDBYID(String value) {
