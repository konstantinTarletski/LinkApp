...
@AllArgsConstructor
@Entity
@Table(name = "merchant_par")
@NamedQuery(name = "get.all.items.lv.bank.cards.core.entity.cms.MerchantPar.to.lv.bank.cards.core.entity.linkApp.PcdMerchantPar",
        query = "select m from MerchantPar m where m.chr1 is not null")
public class MerchantPar implements java.io.Serializable {
