...
@XmlType(name = "RowType_EventBalanceResponse", propOrder = {
    "codeOwner",
    "limitType",
    "limitKeyType",
    "limitKeyValue",
...
public class RowTypeEventBalanceResponse {
    ...
    @XmlElement(name = "limit_balance")
    protected RowTypeLimitBalance limitBalance;
     ...
     * @return
     *     possible object is
     *     {@link RowTypeLimitBalance }
     *     
     */
    public RowTypeLimitBalance getLimitBalance() {
        return limitBalance;
    }
     ...
     *     
     */
    public void setLimitBalance(RowTypeLimitBalance value) {
